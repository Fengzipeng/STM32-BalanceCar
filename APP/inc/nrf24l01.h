...
#define NRF_CSN_HIGH   GPIO_SetBits(GPIOA,GPIO_Pin_3)
#define NRF_CSN_LOW    GPIO_ResetBits(GPIOA,GPIO_Pin_3)
...
void NRF24L01_Init(u8 Mode);					//初始化
...
u8 NRF24L01_Send_Data(u8 *txBuf);
u8 NRF24L01_ReceiveData(u8 *rxBuf);
void NRF24L01_ModeSet(u8 mode);    //模式的设置
#endif
